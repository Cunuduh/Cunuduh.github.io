const galleryData = {
  artwork: [
    ...
    },
    {
      ...
      description: "In my triptych, I created three pieces that represent different aspects of my condition. The person is meant to be me as I want to see myself: with long hair; eyes closed, but looking deeply and truly into the condition of the mind. For the place, I made a surreal, dreamlike fantasy version of 'outside', unclear and disconnected from the red theatre curtains, like I'm watching the play of my own life. The thing in my triptych is a round, ruby gem with a cross shape underneath, and an arm just out of reach—the gem is meant to look like ♀, the Venus symbol and common female sex symbol. I arranged these pieces specifically as place, person, then thing, using red as a common motif throughout the curtain, hair, and ruby gem to represent passion and intense emotion. The brush strokes in the curtains and hair create movement that guides viewers' eyes toward the right, ending at the back of my head. This flow gets interrupted—on purpose—by an arm breaking through the cold, blue veil, reaching for that gem that represents my passion and identity. I'm actually really pleased with how my watercolour technique turned out. I was careful to use a good range of values and not overload the paper like I'd done before, and every stroke of colour was intentional—that's where my skill really shows. The one thing I'd change is how I conveyed my message about gender dysphoria. When I showed it to people, they didn't really get what it was about, and I don't want to have to explain it every time someone looks at my artwork. I'd probably go back to planning and use others' feedback to make the message clearer.",
